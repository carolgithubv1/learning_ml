...
# Example of x which lets the binary tree to remain more nodes after pruning
# when d = 5
# Input: x_original = [[0.36239711090152626, 0.9505049969166952], [0.4404281911988689, 0.6607685025611586], [0.4147504722753387, 0.999669689737674], [0.10885687709147274, 0.7153656432244169], [0.20877758191111295, 0.98956706327814]
# when d = 4
...
x_orig = x # x(a,b) was stored for each node on the binary tree
x_updated = []
turn = 'a'
# a = float('-inf')
# b = float('inf')
