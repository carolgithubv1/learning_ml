...
for k in range(N_epoch):
    ...
    for jj in range(N_batches):
        ...
        # index of minimum of epsilon sum
        # epsilon_sum_perBatch_min_index[jj] = np.argmin(np.asarray(epsilon_sum_perBatch_list))
        # save such index in a list
        # epsilon_sum_perBatch_min_index_list.append(float(epsilon_sum_perBatch_min_index[jj]))
        # sum_epsilon/N_xy_perBatch, or np.mean(epsilon_sum_perBatch_min_index_list)
        # epsilon_sum_mean[jj] = epsilon_sum_perBatch_min_index_list/N_xy_perBatch
        # epsilon_sum_mean_list.append(float(epsilon_sum_mean[jj]))
    ...
    epsilon_sum_min_index_allBatches.append(epsilon_min_index_allBatches)
    ...
    epsilon_sum_min = min(np.asarray(epsilon_sum_mean_list))
